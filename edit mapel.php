...
if (isset($_GET['id_mapel'])) {
    ...
    $query = mysqli_query($conn, "SELECT * FROM mapel WHERE id_mapel='$id_mapel'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form method="post" action="update mapel.php">
                                <div class="mb-3">
                                    <label for="id_mapel" class="form-label">ID Mapel</label>
                                    <input type="text" class="form-control" id="id_mapel_display" value="<?php echo $data['id_mapel']; ?>" disabled>
                                    <input type="hidden" name="id_mapel" value="<?php echo $data['id_mapel']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Nama Mata Pelajaran</label>
                                    <select class="form-control" id="nama_mapel" name="nama_mapel">
                                        <option value="" disabled selected>Pilih Mata Pelajaran</option>
                                        <option value="Platform Komputasi Awan">Platform Komputasi Awan</option>
                                        <option value="Layanan Komputasi Awan">Layanan Komputasi Awan</option>
                                        <option value="Infrastruktur Komputasi Awan">Infrastruktur Komputasi Awan</option>
                                        <option value="Sistem Keamanan Jaringan">Sistem Keamanan Jaringan</option>
                                        <option value="Sistem Internet of Things">Sistem Internet of Things</option>
