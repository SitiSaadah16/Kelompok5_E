            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form method="post" action="update jurusan.php">
                                <div class="mb-3">
                                    <label for="id_jurusan" class="form-label">ID Jurusan</label>
                                    <input type="text" class="form-control" id="id_jurusan_display" value="<?php echo $data['id_jurusan']; ?>" disabled>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="nama_jurusan" name="nama_jurusan">
                                        ...
                                        <option value="Sistem Informasi Jaringan Aplikasi">Sistem Informasi Jaringan Aplikasi</option>
                                        <option value="Pengembangan Perangkat Lunak & Game">Pengembangan Perangkat Lunak & Game</option>
