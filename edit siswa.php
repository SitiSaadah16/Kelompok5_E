    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">SIAKAD JURUSAN SIJ</div>
            </a>
                        ...
                        <div class="card-body">
                            <form method="post" action="update siswa.php">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="id_siswa_display" value="<?php echo $data['id_siswa']; ?>" disabled>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="alamat" name="alamat"><?php echo htmlspecialchars($data['alamat']); ?></textarea>
                                </div>
                                <div class ="mb-3">
                                    <label for="kelas" class="form-label">Kelas</label>
                                    <input type="text" class="form-control" id="kelas" name="kelas" value="<?php echo htmlspecialchars($data['kelas']); ?>">
                                </div>
                                <div class ="mb-3">
                                    <label for="jurusan" class="form-label">Jurusan</label>
                                    <input type="text" class="form-control" id="jurusan" name="jurusan" value="<?php echo htmlspecialchars($data['jurusan']); ?>">
                                </div>
