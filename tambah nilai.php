        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Form Tambah Data Nilai</h1>
                    <form method="POST" action="tnilai.php">
                        <div class="mb-3">
                            <label for="id_nilai" class="form-label">ID Nilai</label>
                            <input type="text" class="form-control" id="id_nilai" name="id_nilai" required>
                        </div>
                        <div class="mb-3">
