    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Form Tambah Data Mata Pelajaran</h1>
                <form method="POST" action="tmapel.php">
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">ID Mapel</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" naame="id_mapel">
                </div>
                <div class="mb-3">
